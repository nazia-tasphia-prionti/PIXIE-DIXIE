...
public class MenuController {
    ...
    private void loadGameScene3() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/example/start_till_game/loadingpage.fxml"));//eikhane jeitar sathe connect korte chao oitar fxml file er naam ta diyo (same hocche sob gular jonno)
    ...
    private void loadGameScene4() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/example/start_till_game/game2.fxml"));//eikhane jeitar sathe connect korte chao oitar fxml file er naam ta diyofxml
            AnchorPane gameRoot = loader.load();
    ...
    private void loadGameScene2() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/example/start_till_game/game2.fxml"));
            AnchorPane gameRoot = loader.load();
